![docker image](https://github.com/ZBT-Tools/Nomad/actions/workflows/docker-publish.yml/badge.svg)
...
2. Clone the repository or download the repository as a zip file.
    ...
    ```sh
    git clone https://github.com/ZBT-Tools/Nomad.git
    cd Nomad
    ```
    ...
    ```sh
    curl-L -o Nomad.zip "https://github.com/ZBT-Tools/Nomad/archive/main.zip"
    unzip Nomad.zip
    cd Nomad
    ```
...
your `docker-compose.yaml` with `ghcr.io/zbt-tools/nomad:main` for the services
...
```sh
docker pull ghcr.io/zbt-tools/nomad/jupyter:main
```
...
_I get an_ `Error response from daemon: Head "https://ghcr.io/v2/ZBT-Tools/Nomad/manifests/main": unauthorized`
